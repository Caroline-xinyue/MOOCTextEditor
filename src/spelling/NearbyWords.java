...
//					break outerloop;
//				}
				if(!currentList.contains(sb) && (!wordsOnly || dict.isWord(sb.toString())) && !s.equals(sb.toString())) {
					currentList.add(sb.toString());
					//System.out.println(sb.toString());
				}
			}
...
//			}
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		int index = 0;
		while(!queue.isEmpty() && index < numSuggestions) {
			String curr = queue.remove(0);
			List<String> suggestionList = distanceOne(curr, true);
   ...
   public static void main(String[] args) {
	   /* testing for the distanceOne method(substitution, insertion, deletion) */
//	   String word = "word";
